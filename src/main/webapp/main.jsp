...
<script src="${pageContext.request.contextPath}/static/js/plugins/flot/jquery.flot.spline.js"></script>
...
<script src="${pageContext.request.contextPath}/static/js/plugins/flot/jquery.flot.symbol.js"></script>
...
<script src="${pageContext.request.contextPath}/static/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${pageContext.request.contextPath}/static/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="${pageContext.request.contextPath}/static/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="${pageContext.request.contextPath}/static/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="${pageContext.request.contextPath}/static/js/demo/sparkline-demo.min.js"></script>
<script>
